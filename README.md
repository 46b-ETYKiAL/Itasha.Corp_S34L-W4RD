<p align="center">
  <picture>
    <img src=".github/assets/header.svg" width="100%" alt="SealWard — cross-platform code-signing orchestrator. A retro-future anime-OS banner: a CRT bezel with phosphor scanlines over the wordmark S34L-W4RD in signal-teal monospace.">
  </picture>
</p>
...
from handles. The signer's own releases carry Sigstore + SBOM + SLSA provenance.
The full design rationale lives in the architecture ADR under `docs/adr/`.
...
`.github/assets/footer.svg`. Only SVG sources are tracked — rasterized outputs
are git-ignored and regenerated on demand.
...
<p align="center">
  <img src=".github/assets/footer.svg" width="100%" alt="SealWard footer — a CRT phosphor strip in void-black with a signal-teal scanline.">
</p>
